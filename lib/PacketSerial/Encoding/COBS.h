...
public:
    ...
    ///          allocated.
    static unsigned long encode(const uint8_t* buffer,
                         unsigned long size,
                         uint8_t* encodedBuffer)
    {
        unsigned long read_index  = 0;
        unsigned long write_index = 1;
    ...
    static unsigned long decode(const uint8_t* encodedBuffer,
                         unsigned long size,
    ...
    static unsigned long getEncodedBufferSize(unsigned long unencodedBufferSize)
    {
